    ...
    <Screen>
      <View style={styles.container}>
        ...
        <View style={styles.btnWrapper}>
          <MaterialIcons
            ...
            color={colors.green}
          />
          <Text style={styles.text}> Update Current Location</Text>
        </View>
        <View style={styles.btnWrapper}>
          <MaterialCommunityIcons
            onPress={() => {
      ...
      <View style={styles.modal}>
        ...
        <Dialog.Container visible={visibleLocation}>
          <Dialog.Title>Update Current Location</Dialog.Title>
          <Dialog.Description>
            Do you want to updaye your current location?
          </Dialog.Description>
          <Dialog.Button label="Cancel" onPress={handleCancelLocation} />
          <Dialog.Button label="Update" onPress={handleLocation} />
        </Dialog.Container>
      </View>
    </Screen>
  );
