...
export default function OffersScreen() {
  ...
  const setData = () => {
    setRequests(
      data
        ?.map((i) => ({ ...i }))
        .filter((f) => f.isRequest === false && f.user === user.uid)
    );
      ...
      <Screen>
        ...
        <View style={styles.welcomeWrap}>
          ...
          <Text style={styles.match}>
            You can see, add or delete your offers
          </Text>
        </View>
            ...
            <ScrollView scrollbars="none">
              ...
              >
                ...
                <SelectFromField
                  name="pet"
                  arr={kindOfPet}
                  text="Choose the pet for which you are ready to look after"
                />
                <CalendarSeelectField
                  name="dates"
                  tillName="dates.till"
                  fromName="dates.from"
                  text="Pick dates when your are ready to look after the guest pet"
                />
