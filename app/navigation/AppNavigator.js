...
const AppNavigator = () => {
  ...
  >
    ...
    <Tab.Screen name="Chat" component={ChatNavigation} options={({navigation, route}) => ({tabBarIcon: ({ color, size, focused}) => (<Ionicons name={focused ? "chatbubbles" : "chatbubbles-outline"} size={24} color={colors.green} />)})}/>
